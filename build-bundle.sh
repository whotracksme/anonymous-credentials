...
emcc -s WASM=1 -std=c99 -Wall -Wextra -Wno-strict-prototypes -Wunused-value -Wcast-align -Wunused-variable -Wundef -Wformat-security -Wshadow -O2 -o group-sign-bindings.js  -L$DIR/milagro-crypto-c/target/default/src -Wl,-rpath,$DIR/milagro-crypto-c/target/default/src -rdynamic $DIR/milagro-crypto-c/target/default/src/libgroupsign.a $DIR/milagro-crypto-c/target/default/src/libamcl_curve.a $DIR/milagro-crypto-c/target/default/src/libamcl_core.a $DIR/milagro-crypto-c/target/default/src/libamcl_pairing.a -s EXPORTED_FUNCTIONS="['_GS_seed', '_GS_createState', '_GS_setupGroup', '_GS_loadGroupPrivKey', '_GS_loadGroupPubKey', '_GS_startJoin', '_GS_finishJoin', '_GS_loadUserPrivKey', '_GS_exportGroupPrivKey', '_GS_exportGroupPubKey', '_GS_exportUserPrivKey', '_GS_processJoin', '_GS_sign', '_GS_verify', '_GS_getSignatureTag', '_GS_destroy']"
